        ...
        return (
            <Grid>
                <Row style={{flex:2, flexDirection:'column', backgroundColor:'#228B22'}}>
                    <View style={{flex:3}} />
                    <View style={{flex:6}}>
                        <Text style={{color:'white', fontSize:22, textAlign:'center'}}>Ski World</Text>
                    </View>
                    <View style={{flex:1}} />
                </Row>
                <Row style={{flex:26}}>
                    <TabBar tabName='golfWorld' deals={ deals }/>
                </Row>
            </Grid>
        )
    }
...
export default connect(mapStateToProps, bindAction)(MainSki);
